...
class RiskEngine:
    ...
    Combines multiple security signals into
    a single transaction risk score.
    """
    ...
    def calculate_risk(
        ...
        if amount_ratio >= 20:
            ...
            reasons.append(
                "Transaction amount is extremely "
                "higher than agent's normal behavior"
            )
        ...
        # ML is advisory.
        # It cannot independently block a transaction.
